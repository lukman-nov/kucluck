  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
      ...
      let menuOptions = [{
        ...
        {
          label: client.la[ls].cmds.info.help.menuOptions.label10,
          value: client.la[ls].cmds.info.help.menuOptions.value10,
          emoji: client.la[ls].cmds.info.help.menuOptions.emoji10,
          description: client.la[ls].cmds.info.help.menuOptions.description10,
        }
      ];
