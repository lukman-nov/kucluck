...
const Schema = require('../../databases/reaction-roles2');
const emojis = require('../../botconfig/emojis.json');
const ee = require('../../botconfig/embed');
const url = require('../../botconfig/url.json');

module.exports = {
  name: "setup-reactionrole2",
  aliases: ["react-add2", "reactadd2", "roleadd2", "role-add2"],
  category: `Premium`,
  description: "Add roles to database bot",
  usage: "setup-reactionrole2 <@roles> <emoji> <description>",
